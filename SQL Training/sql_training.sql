...
'AAA', 'Berlin', '+923518462+6', '10555 - Berlin', 'Germany', '10555', 'Eur');
SHOW TABLES;
...
('1', 'San Francisco', '+4912223658', '100 mkt St', 'Suit 300','CA', 'USA', '94080', 'NA'),
('2', 'Boston', '+4912223658', '1550 Court Place', 'Suit 310','MA', 'USA', '82107', 'NA'),
('3', 'NYC', '+4912223658', '523 Each 53rd St', 'Apt 5A','NY', 'USA', '10022', 'NA'),
('4', 'Paris', '+4912223658', '43 Rue Jouffroy DAlbana', NULL,NULL, 'France', 'NA', 'Eur'),
('5', 'Tokyo', '+4912223658', '4-1 Kichino', NULL,'Chiyado-Ku', 'Japan', '10285', 'Asia'),
('6', 'Sydney', '+4912223658', '5-11 Wentworth Avenue', 'Floor #2',NULL,'Australia', 'NSW-2', 'APAC'),
('7', 'London', '+4912223658', '25 Old Broad St', 'Level 7',NULL, 'UK', 'EC652', 'Eur');
...
INSERT INTO offices(officecode, city, phone, addressline1, country, postalcode, territory) VALUES (
'8', 'Karachi', '+9235184626', 'DHA Ph-6', 'Pakistan', '76600', 'Asia');
INSERT INTO employees
(`employeeNumber`,`lastName`,`firstName`,`extension`,`email`,`officeCode`,`reportsTo`,`jobTitle`) VALUES
('2009','Ali','Mali','x963','m.ali@classicmodelcars.com','8','1002','Manager'),
('2096','Bism','Zan','x999','bismz@classicmodelcars.com','8','2009','Assistant Manager'),
('2100','Daniya','Saif','x991','saif.d@classicmodelcars.com','8','2096','Sales Rep'),
('2152','Ishq','rul','x992','ishq@classicmodelcars.com','8','2096','Sales Rep'),
('2162','Zulfi','Zulfi','x993','zulfi@classicmodelcars.com','8','2096','Sales Rep');
...
SELECT firstname, lastname, officeCode FROM classicmodels.employees WHERE jobTitle = "Sales Rep";
SELECT * FROM classicmodels.employees WHERE jobTitle != "Sales Rep";
SELECT * FROM classicmodels.employees WHERE jobTitle = "Sales Rep" AND officeCode = "1";
SELECT * FROM classicmodels.offices;
DELETE FROM classicmodels.offices WHERE officeCode = "AAA";
SELECT * FROM classicmodels.offices;
UPDATE classicmodels.employees SET reportsTo = "1002" WHERE jobtitle = "Sales Rep" AND officeCode = "1";
SELECT * FROM classicmodels.employees;
UPDATE classicmodels.employees SET jobTitle = "Sales Manager" WHERE  employeeNumber = "2096";
UPDATE classicmodels.employees SET jobTitle = "VP Sales (Asia)" WHERE  employeeNumber = "2009";
SELECT * FROM classicmodels.employees;


/* Exercises:
*/
--- List the customers in US with a credit limit >1000
SELECT * FROM classicmodels.customers;
SELECT * FROM classicmodels.customers WHERE country = "USA" AND creditLimit > "1000";

--- List the employeesCode for salesrep of customers in Spain, France, italy. make another query to list the names and emails of those employees
DESCRIBE customers;
SELECT salesRepEmployeeNumber FROM classicmodels.customers WHERE Country IN ("Spain", "France", "Italy");
SELECT firstName, lastName, email from classicmodels.employees WHERE employeeNumber IN ("1370", "1337", "1702", "1401");
 
--- change the job title from sales Rep to Sales Representatives
DESCRIBE classicmodels.employees;
UPDATE classicmodels.employees SET jobTitle = "Sales Representative" WHERE jobTitle = "Sales Rep";
SELECT * FROM classicmodels.employees;
SELECT customerName, country FROM classicmodels.customers WHERE customerName LIKE '%Toys%';
...
SELECT * FROM classicmodels.products ORDER BY buyPrice DESC LIMIT 10; 
-- List 5 most expensive products
SELECT * FROM classicmodels.products ORDER BY buyPrice DESC LIMIT 5;
SELECT * FROM classicmodels.products ORDER BY MSRP DESC LIMIT 5;

-- Identify the products which has stk<100
SELECT * FROM classicmodels.products WHERE quantityInStock<100 ORDER BY quantityInStock DESC;

-- list 10 products in the Motorcycle category with the lowest buy proice and more han 1000 in qty
SELECT productName, productLine, buyPrice, quantityInStock  FROM classicmodels.products WHERE productLine = "Motorcycles" AND quantityInStock > 1000 ORDER BY buyPrice ASC LIMIT 10;


-- Creating tables for Orders, Order Details & Payments
...
DESCRIBE classicmodels.employees;
ALTER TABLE classicmodels.employees ADD hiredOn DATE;
DESCRIBE classicmodels.employees;
...
-- Aggreggation, grouping and Aliases (count, avg, sum, min, max)

-- report the total no of payments recieved b4 oct 28, 2004.
SELECT * FROM classicmodels.payments WHERE paymentDate < "2004-10-28";
SELECT COUNT(*) FROM classicmodels.payments WHERE paymentDate < "2004-10-28";

-- report the total no of (unique)customers paid b4 oct 28, 2004.
SELECT COUNT(DISTINCT customerNumber) FROM classicmodels.payments WHERE paymentDate < "2004-10-28"; 

-- Details of customers paid b4 oct 28, 2004.   Chain Quarries
SELECT * FROM classicmodels.customers WHERE customerNumber IN 
	(SELECT DISTINCT customerNumber FROM classicmodels.payments WHERE paymentDate < "2004-10-28");

-- Retrieve details of all customers in US who have made payments b/w 1 Apr 2003 - 31 Mar 2004

-- 1st step: unique customers who made payments b/w 1 Apr 2003 - 31 Mar 2004
SELECT COUNT(DISTINCT customerNumber) FROM classicmodels.payments WHERE paymentDate BETWEEN "2003-04-01" AND "2004-03-31";
-- 2nd step: Retrieve customer details from customer table Where customer id in prev table and in US
DESC classicmodels.customers;
SELECT * FROM classicmodels.customers WHERE country = "USA";
SELECT * FROM classicmodels.customers WHERE customerNumber IN
	(SELECT DISTINCT customerNumber FROM classicmodels.payments WHERE paymentDate BETWEEN "2003-04-01" AND "2004-03-31") AND
    country = "USA";
SELECT COUNT(*) FROM classicmodels.customers WHERE customerNumber IN
	(SELECT DISTINCT customerNumber FROM classicmodels.payments WHERE paymentDate BETWEEN "2003-04-01" AND "2004-03-31") AND
    country = "USA";



-- Find the Total no of payments made by each customer b4 28 Oct 2004
SELECT customerNumber, COUNT(*) as numberOfPayments
	FROM classicmodels.payments 
    WHERE paymentDate <"2004-10-28" 
    GROUP BY customerNumber;

-- Find the total no of payments and total payment amount for each customer for payments made b4 28 oct 2004. 
SELECT customerNumber, COUNT(*) AS numberOfPayments, SUM(amount) AS sumTotal, MAX(amount) AS largestPayment, MIN(amount) AS smallestPayment, AVG(amount) as averagePayment
	FROM classicmodels.payments 
    WHERE paymentDate < "2004-10-28" 
    GROUP BY customerNumber;

-- Total no of unit sold for each product & its order frequency (arranged by the order freq DESC)
DESC orderdetails;
SELECT productCode, COUNT(*) AS orderFrequency, SUM(quantityOrdered) AS unitSold
	FROM classicmodels.orderdetails
    GROUP BY productCode
    ORDER BY orderFrequency DESC;

-- Retrieve the 10 customers who paid most b4 28 oct 2004
DESCRIBE classicmodels.payments;
SELECT customerNumber, COUNT(*) AS noOfPayments, SUM(amount) AS sumTotal
	FROM classicmodels.payments 
	WHERE paymentDate< "2004-10-28"
    GROUP BY customerNumber ORDER BY sumTotal DESC LIMIT 10;

SELECT customerNumber, COUNT(*) AS noOfPayments, SUM(amount) AS sumTotal
	FROM classicmodels.payments 
	WHERE paymentDate< "2004-10-28"
    GROUP BY customerNumber ORDER BY sumTotal DESC LIMIT 10 OFFSET 10; 

-- Display the full name of point of contact for each customer in US, in uppercase, with phone no, sorted alphabatically..
DESCRIBE classicmodels.customers;
SELECT customerNumber, customerName, UCASE(CONCAT(contactFirstName, " ", contactLastName)) AS contactName, phone  
	FROM classicmodels.customers WHERE country = "USA" ORDER BY contactName ASC;


-- Display a paginated list of customers (sorted) with a country code column. The country code is simply the first 3 letters of the country name in lowercase
SELECT customerNumber, customerName, LCASE(SUBSTRING(country,1,3)) AS countryCode 
	FROM classicmodels.customers ORDER BY customerName ASC LIMIT 10 ;


-- Display 5 most expensive products in a motorcycle line, with MRSP rounded to nearest dollar
SELECT * FROM classicmodels.productlines;
SELECT productCode, productName, ROUND(MSRP) AS MSRP
	FROM classicmodels.products 
    WHERE productLine = "Motorcycles" ORDER BY MSRP DESC LIMIT 5;

-- Display the productCode, productName, buyPrice, salePrice & profit margin % ((MSRP - buyPrice)*100/buyPrice) for highest 10 products with profit margins correct to 2 dp.
SELECT productCode, productName, buyPrice, MSRP, ROUND((MSRP - buyPrice)*100/buyPrice,2) AS profitMargin_percentage
	FROM classicmodels.products ORDER BY profitMargin_percentage DESC LIMIT 10;
    
-- List the largest single payment by each customer in 2004, orderd by descending order
SELECT customerNumber, MAX(amount) AS amount 
	FROM classicmodels.payments 
    WHERE YEAR(paymentDate) = 2004
    GROUP BY customerNumber ORDER BY amount DESC LIMIT 10; 

-- Show payments by per month each year (Revenue Table)
SELECT YEAR(paymentDate) AS payment_Yr, DATE_FORMAT((paymentDate),"%M") AS payment_Month, CONCAT("$",FORMAT(SUM(amount),2)) AS revenue; 
...
SELECT YEAR(paymentDate) AS payment_Yr, DATE_FORMAT((paymentDate),"%M") AS payment_Month, CONCAT("$",FORMAT(SUM(amount),2)) AS revenue 
    FROM classicmodels.payments
    GROUP BY payment_Yr, payment_Month
    ORDER BY payment_Yr, payment_Month ASC;



-- Join - combines tables with a mutual columns (By default inner join - intersectional values)

-- 10 most recent payments with customer details(name & phone#)
SELECT * FROM classicmodels.payments JOIN classicmodels.customers 
	ON payments.customerNumber = customers.customerNumber
    ORDER BY paymentDate DESC LIMIT 10;

SELECT * 
FROM classicmodels.payments 
LEFT JOIN classicmodels.customers ON payments.customerNumber = customers.customerNumber

UNION

SELECT * 
FROM classicmodels.payments 
RIGHT JOIN classicmodels.customers ON payments.customerNumber = customers.customerNumber;


SELECT * FROM classicmodels.offices;
-- Show full off address and phone no for each employees
SELECT employeeNumber, lastName, firstName, offices.officeCode, 
	CONCAT(offices.phone, extension)  AS phone, offices.city
	FROM classicmodels.employees JOIN classicmodels.offices
	ON employees.officeCode = offices.officeCode;

-- Show the full order info and product details for order no 10100
SELECT * FROM classicmodels.orders;
SELECT * FROM classicmodels.orderdetails;
SELECT * FROM classicmodels.products;

SELECT orderdetails.orderNumber, orderdetails.productCode, quantityOrdered, priceEach, orders.orderDate, orders.shippedDate, orders.customerNumber,
	products.productName, products.productDescription, products.productLine
	FROM classicmodels.orderdetails 
